...
module.exports = (message) => {
  ...
  if (komut && (komut.isim === "teyitver")) {
    if (!message.member.roles.cache.has("775331244614352897") && !message.member.roles.cache.has(ayar.sahipRolu) && !conf.sahip.some(id => message.author.id === id)) return;
    uye.roles.add(["775331266173599764", "775331271445839912"]);
    return message.react(client.emojiler.onay);
  };
